...
import {AccountConfigPatch, PasswordChangeContainer, PasswordFieldContainer, UrlFieldContainer} from "_@shared/model/container";
...
export const OPTIONS_ACTIONS = unionize({
        AddAccountRequest: ofType<AccountConfigPatch>(),
