...
import {ProtonPrimaryMailApi} from "src/shared/api/webview/primary-mail";
...
): Pick<ProtonPrimaryMailApi, "buildDbPatch" | "throwErrorOnRateLimitedMethodCall" | "fetchSingleMail"> => {
            ...
            const deferFactory = (): Observable<BuildDbPatchMethodReturnType> => {
                ...
                return from((async () => {
                    ...
                    await lastValueFrom(race(
                        commonProviderApi._custom_.loggedIn$.pipe(
