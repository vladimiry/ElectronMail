    ...
    toggleBrowserWindow$ = createEffect(
        () =>
            this.actions$.pipe(
                ...
                concatMap(({payload}) =>
                    from(this.electronService.ipcMainClient()("toggleBrowserWindow")(payload)).pipe(
                        mergeMap(() => EMPTY),
                    )
                ),
            ),
    ...
    openAboutWindow$ = createEffect(
        () =>
            this.actions$.pipe(
                ...
                concatMap(() =>
                    from(this.electronService.ipcMainClient()("openAboutWindow")()).pipe(
                        mergeMap(() => EMPTY),
                    )
                ),
            ),
    ...
    openExternal$ = createEffect(
        () =>
            this.actions$.pipe(
                ...
                concatMap(({payload}) =>
                    from(this.electronService.ipcMainClient()("openExternal")({url: payload.url})).pipe(
                        mergeMap(() => EMPTY),
                    )
                ),
            ),
    ...
    quit$ = createEffect(
        () =>
            this.actions$.pipe(
                ...
                concatMap(() =>
                    from(this.electronService.ipcMainClient()("quit")()).pipe(
                        mergeMap(() => EMPTY),
                    )
                ),
            ),
