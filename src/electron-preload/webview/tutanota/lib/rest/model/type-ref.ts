import {BaseEntity, Id, IdTuple, TypeRef} from "./common";
import {File, Mail, MailBody, MailBox, MailboxGroupRoot, MailFolder} from "./response";
...
function buildTutanotaTypeRef<T extends BaseEntity<Id | IdTuple>>(type: Pick<TypeRef<T>, "type">["type"]): TypeRef<T> {
    return {
        app: "tutanota",
        type,
    } as any;
