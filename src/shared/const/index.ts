...
export const RUNTIME_ENV_ALLOW_MULTIPLE_INSTANCES = "ALLOW_MULTIPLE_INSTANCES";

export const RUNTIME_ENV_USER_DATA_DIR_BASED_KEYCHAIN_RECORD = "USER_DATA_DIR_BASED_KEYCHAIN_RECORD";
