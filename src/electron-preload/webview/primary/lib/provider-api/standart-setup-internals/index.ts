...
import {resolveStandardSetupProviderInternals} from "./internals";
import {StandardSetupPublicScope} from "src/electron-preload/webview/primary/lib/provider-api/standart-setup-internals/model";
