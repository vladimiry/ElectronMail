...
import {PROTON_PRIMARY_LOGIN_IPC_WEBVIEW_API, ProtonPrimaryLoginApi} from "src/shared/api/webview/primary-login";
...
export function registerApi(): void {
    const endpoints: ProtonPrimaryLoginApi = {
    ...
    PROTON_PRIMARY_LOGIN_IPC_WEBVIEW_API.register(endpoints, {logger: _logger});
    ipcRenderer.sendToHost(IPC_WEBVIEW_API_CHANNELS_MAP.login.registered);
