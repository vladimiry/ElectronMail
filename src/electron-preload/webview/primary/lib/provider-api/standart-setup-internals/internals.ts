...
export const resolveStandardSetupProviderInternals = async (_logger: Logger): Promise<StandardSetupProviderInternals> => {
    const logger = curryFunctionMembers(_logger, nameof(resolveStandardSetupProviderInternals));
